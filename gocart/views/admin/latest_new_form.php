...
<?php echo form_open_multipart($this->config->item('admin_folder').'/latest_news/form/'.$id, 'class="form-horizontal"'); ?>
		...
		<div class="panel blank-panel">
			...
			<div class="panel-heading">
				<div class="panel-title m-b-md">
					<h4><?php echo lang('latest_news_form')?></h4>
				</div>
			...
			<div class="panel-body">
				...
				<div class="tab-pane" id="seo_tab">
					<div class="form-group">
						...
						<!-- Content Description with new text area -->
					</div>
