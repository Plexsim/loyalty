                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-title">
                            <h5><?php echo lang('voucher_form')?></h5>                            
                        </div>
                        
                        <div class="ibox-content">

                        <?php echo form_open_multipart($this->config->item('admin_folder').'/vouchers/form/'.$id, 'class="form-horizontal"'); ?>                                               
                         ...
                         <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('voucher_code');?></label>
						  ...
						  <div class="form-group"><label class="col-sm-2 control-label"><?php echo lang('voucher_name');?></label>
							<?php
