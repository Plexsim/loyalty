...
function areyousure()
{
	...
	<a class="btn btn-white btn-bitbucket" style="float:right;" href="<?php echo site_url($this->config->item('admin_folder').'/vouchers/form'); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_voucher');?></a>
